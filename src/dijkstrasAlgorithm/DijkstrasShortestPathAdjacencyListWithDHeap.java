...
public class DijkstrasShortestPathAdjacencyListWithDHeap {
	 ...
	 * the {@link #addEdge} method to actually add edges to the graph.
	 *
	...
	public static void main(String[] args) {
		...
		DijkstrasShortestPathAdjacencyListWithDHeap solver = new DijkstrasShortestPathAdjacencyListWithDHeap(n);
		solver.addEdge(0, 1, 3);
		solver.addEdge(0, 2, 2);
		solver.addEdge(0, 5, 3);
		solver.addEdge(1, 3, 1);
		solver.addEdge(1, 2, 6);
		solver.addEdge(2, 3, 1);
		solver.addEdge(2, 4, 10);
		solver.addEdge(3, 4, 5);
		solver.addEdge(5, 4, 7);
		int s = 0;
		int e = 4;

		System.out.println("Shortest Path from " + s + " to " + e + ": " + solver.dijkstra(s, e));
