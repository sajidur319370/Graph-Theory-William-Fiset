...
public class FordFulkersonExample {
	...
	private static class Edge {
		...
		public String toString(int s, int t) {
			...
			return String.format("Edge %s -> %s | flow = %3d | capacity = %3d | is residual: %s", u, v, flow, capacity,
					isResidual());
		}
	}
	...
	private abstract static class NetworkFlowSolverBase {
		 ...
		 * you to inspect the {@link Edge#flow} and {@link Edge#capacity} values of each
		 * edge. This is useful if you are debugging or want to figure out which edges
	...
	public static void example1() {
		...
		solver.addEdge(s, 1, 7);
		solver.addEdge(s, 2, 4);

		// Middle edges
		solver.addEdge(1, 3, 5);
		solver.addEdge(1, 4, 3);
		solver.addEdge(2, 1, 3);
		solver.addEdge(2, 4, 2);
		solver.addEdge(4, 3, 3);

		// Edges to sink
		solver.addEdge(3, t, 8);
		solver.addEdge(4, t, 5);
