...
/**
 * This Topological sort takes an adjacency matrix of an acyclic graph and
 * returns an array with the indexes of the nodes in a (non unique) topological
 * order which tells you how to process the nodes in the graph. More precisely
...
public class TopologicalSortAdjacencyMatrix {
	...
	// between two nodes in a Directed Acyclic Graph (DAG). Given an adjacency
	// matrix
