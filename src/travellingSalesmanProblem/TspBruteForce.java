...
/**
 * This file shows you how to solve the traveling salesman problem using a brute
 * force approach. Since the time complexity is on the order of O(n!) this
 * method is not convenient for n > 12
 *
 * <p>
 * Time Complexity: O(n!)
 *
...
public class TspBruteForce {
	...
	// Generates the next ordered permutation in-place (skips repeated
	// permutations).
	// Calling this when the array is already at the highest permutation returns
	// false.
	// Recommended usage is to start with the smallest permutations and use a do
	// while
